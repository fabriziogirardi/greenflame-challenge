            ...
            <div class="bg-white shadow-sm sm:rounded-lg pl-10 pr-4 py-2">
                <form action="{{ route('discount.update', ['discount' => $discount->id]) }}" method="POST">
                    ...
                    <div class="flex flex-wrap items-center mt-4">
                        ...
                        <input name="name" id="name" type="text" class="border border-gray-300 rounded rounded-md text-neutral-700 ml-4 w-1/4" value="{{ $discount->name }}"/>
                        ...
                        <input name="active" id="active" type="checkbox" value="1" class="mx-4" {{ $discount->active ? 'checked' : '' }} />
                        @error('name')
                            <div class="text-sm text-red-600 w-full">{{ $message }}</div>
                        @enderror
                    </div>
                    <hr class="my-8">
                    <div class="flex items-center gap-8">
                            ...
                            <div>
                                <select class="rounded border-gray-300 w-full" name="brand_id">
                                    @foreach($brands as $brand)
                                        <option value="{{ $brand->id }}" {{ $discount->brand->id == $brand->id ? 'selected' : '' }}>{{ $brand->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('brand')
                            ...
                            <div>
                                <select class="rounded border-gray-300 w-full" name="access_type_code">
                                    @foreach($access_types as $access_type)
                                        <option value="{{ $access_type->code }}" {{ $discount->access_type->code == $access_type->code ? 'selected' : '' }}>{{ $access_type->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('accessType')
                        ...
                        <div class="flex flex-col w-1/4">
                            ...
                            <div class="h-full w-full">
                                <input type="text" class="border border-gray-300 rounded rounded-md text-neutral-700 w-full" name="priority" value="{{ $discount->priority }}" />
                            </div>
                            @error('priority')
                                <div class="text-sm text-red-600 w-full">{{ $message }}</div>
                            @enderror
                            ...
                            <div>
                                <select class="rounded border-gray-300 w-full" name="region_id">
                                    @foreach($regions as $region)
                                        <option value="{{ $region->id }}" {{ $discount->region->id == $region->id ? 'selected' : '' }}>{{ $region->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('region')
                    ...
                    <div class="flex gap-2">
                        <div id="period_1" class="flex flex-wrap w-1/3 border border-gray-100 rounded rounded-lg">
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex gap-2 mt-2">
                                    <div><input class="w-3/5 border-gray-400 rounded" name="period_1[from_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_from') }}" value="{{ $discount->discount_range[0]->from_days }}"></div>
                                    <div><input class="w-3/5 border-gray-400 rounded" name="period_1[to_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_to') }}" value="{{ $discount->discount_range[0]->to_days }}"></div>
                                </div>
                            </div>
                            <hr class="w-full">
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex mt-2">
                                    <input class="w-full border-gray-400 rounded" name="period_1[code]" type="text" placeholder="{{ __('app/discounts/create.placeholder_code') }}" value="{{ $discount->discount_range[0]->code ?? '' }}">
                                </div>
                            </div>
                            <div class="p-5 w-full max-w-full">
                                <div class="text-gray-700 font-bold w-full">
                                ...
                                <div class="flex mt-2">
                                    <input class="w-full border-gray-400 rounded" name="period_1[discount]" type="text" placeholder="{{ __('app/discounts/create.placeholder_discount') }}" value="{{ $discount->discount_range[0]->discount ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div id="period_2" class="flex flex-wrap w-1/3 border border-gray-100 rounded rounded-lg relative">
                            ...
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex gap-2 mt-2">
                                    <div><input disabled class="w-3/5 border-gray-400 rounded bg-neutral-300" name="period_2[from_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_from') }}" value="{{ $discount->discount_range[1]->from_days ?? '' }}"></div>
                                    <div><input disabled class="w-3/5 border-gray-400 rounded bg-neutral-300" name="period_2[to_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_to') }}" value="{{ $discount->discount_range[1]->to_days ?? '' }}"></div>
                                </div>
                            </div>
                            <hr class="w-full">
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex mt-2">
                                    <input disabled class="w-full border-gray-400 rounded bg-neutral-300" name="period_2[code]" type="text" placeholder="{{ __('app/discounts/create.placeholder_code') }}" value="{{ $discount->discount_range[1]->code ?? '' }}">
                                </div>
                            </div>
                            <div class="p-5 w-full max-w-full">
                                <div class="text-gray-700 font-bold w-full">
                                ...
                                <div class="flex mt-2">
                                    <input disabled class="w-full border-gray-400 rounded bg-neutral-300" name="period_2[discount]" type="text" placeholder="{{ __('app/discounts/create.placeholder_discount') }}" value="{{ $discount->discount_range[0]->discount ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div id="period_3" class="flex flex-wrap w-1/3 border border-gray-100 rounded rounded-lg relative">
                            ...
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex gap-2 mt-2">
                                    <div><input disabled class="w-3/5 border-gray-400 rounded bg-neutral-300" name="period_3[from_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_from') }}" value="{{ $discount->discount_range[2]->from_days ?? '' }}"></div>
                                    <div><input disabled class="w-3/5 border-gray-400 rounded bg-neutral-300" name="period_3[to_days]" type="text" placeholder="{{ __('app/discounts/create.placeholder_to') }}" value="{{ $discount->discount_range[2]->to_days ?? '' }}"></div>
                                </div>
                            </div>
                            <hr class="w-full">
                            <div class="p-5 w-full max-w-full">
                                ...
                                <div class="flex mt-2">
                                    <input disabled class="w-full border-gray-400 rounded bg-neutral-300" name="period_3[code]" type="text" placeholder="{{ __('app/discounts/create.placeholder_code') }}" value="{{ $discount->discount_range[2]->code ?? '' }}">
                                </div>
                            </div>
                            <div class="p-5 w-full max-w-full">
                                <div class="text-gray-700 font-bold w-full">
                                ...
                                <div class="flex mt-2">
                                    <input disabled class="w-full border-gray-400 rounded bg-neutral-300" name="period_3[discount]" type="text" placeholder="{{ __('app/discounts/create.placeholder_discount') }}" value="{{ $discount->discount_range[2]->discount ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div date-rangepicker class="flex items-center">
                            ...
                            <div class="relative">
                                ...
                                <input datepicker datepicker-format="mm/dd/yyyy" name="start_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('app/discounts/create.placeholder_start_date') }}" value="{{ $discount->start_date }}">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input datepicker datepicker-format="mm/dd/yyyy" name="end_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('app/discounts/create.placeholder_end_date') }}" value="{{ $discount->end_date }}">
                            </div>
                        </div>
                    </div>
                    <div class="mb-12">
