...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'active' => 'activo',
        'brand_id' => 'rentadora',
        'access_type_code' => 'tipo de acceso',
        'priority' => 'prioridad',
        'region_id' => 'región',
        'period_1.from_days' => 'período 1 desde',
        'period_1.to_days' => 'período 1 hasta',
        'period_1.code' => 'período 1 código',
        'period_1.discount' => 'período 1 descuento',
        'period_2.from_days' => 'período 2 desde',
        'period_2.to_days' => 'período 2 hasta',
        'period_2.code' => 'período 2 código',
        'period_2.discount' => 'período 2 descuento',
        'period_3.from_days' => 'período 3 desde',
        'period_3.to_days' => 'período 3 hasta',
        'period_3.code' => 'período 3 código',
        'period_3.discount' => 'período 3 descuento',
        'start_date' => 'período de aplicación desde',
        'end_date' => 'período de aplicación hasta',
    ],
